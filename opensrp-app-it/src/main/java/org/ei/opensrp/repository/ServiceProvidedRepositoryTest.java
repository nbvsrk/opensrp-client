...
public class ServiceProvidedRepositoryTest extends AndroidTestCase {
    ...
    public void testShouldInsertServiceProvidedIntoRepository() throws Exception {
        ServiceProvided serviceProvided = new ServiceProvided("entity id 1", "name", "2013-01-02", EasyMap.mapOf("key 1", "value 1"));
    ...
    public void testShouldFindServicesProvidedByEntityIdAndServiceNames() throws Exception {
        ServiceProvided name1Entity1 = new ServiceProvided("entity id 1", "name 1", "2013-01-02", EasyMap.mapOf("key 1", "value 1"));
        ServiceProvided name2Entity1 = new ServiceProvided("entity id 1", "name 2", "2013-01-02", EasyMap.mapOf("key 1", "value 1"));
        ServiceProvided name3Entity1 = new ServiceProvided("entity id 1", "name 3", "2013-01-02", EasyMap.mapOf("key 1", "value 1"));
        ServiceProvided name1Entity2 = new ServiceProvided("entity id 2", "name 1", "2013-01-02", EasyMap.mapOf("key 1", "value 1"));
