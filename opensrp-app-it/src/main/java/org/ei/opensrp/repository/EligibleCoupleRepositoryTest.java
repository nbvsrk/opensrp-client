...
public class EligibleCoupleRepositoryTest extends AndroidTestCase {
    ...
    public void testShouldInsertEligibleCoupleIntoRepository() throws Exception {
        Map<String, String> details = EasyMap.create("Hello", "There").put("Also", "This").map();
    ...
    public void testShouldUpdateDetailsOfEligibleCoupleIntoRepository() throws Exception {
        Map<String, String> detailsBeforeUpdate = EasyMap.create("Key 1", "Value 1").put("currentMethod", "IUD").map();
        ...
        repository.add(eligibleCouple);
        Map<String, String> detailsToBeUpdated = EasyMap.create("Key 1", "Value 1")
    ...
    public void testShouldMergeDetailsOfEligibleCoupleIntoRepository() throws Exception {
        ...
        EligibleCouple eligibleCouple = new EligibleCouple("CASE X", "Wife 1", "Husband 1", "EC Number", "Village 1", "SubCenter 1", detailsBeforeUpdate);
        repository.add(eligibleCouple);
        Map<String, String> detailsToBeUpdated = EasyMap.create("currentMethod", "Condom").put("familyPlanningMethodChangeDate", "2012-03-03").map();
        Map<String, String> expectedDetails = EasyMap.create("Key 1", "Value 1").put("currentMethod", "Condom").put("familyPlanningMethodChangeDate", "2012-03-03").map();
    ...
    public void testShouldGetCountOfECsWithFPInRepo() throws Exception {
        EligibleCouple ecNotUsingAnyFPMethod = new EligibleCouple("CASE X", "Wife 1", "Husband 1", "EC Number 1", "Village 1", "SubCenter 1", EasyMap.mapOf("currentMethod", "none"));
        ...
        EligibleCouple ecUsingCondomFPMethod = new EligibleCouple("CASE Y", "Wife 2", "Husband 2", "EC Number 2", "Village 2", "SubCenter 2", EasyMap.mapOf("currentMethod", "condom"));
        EligibleCouple ecUsingIUDFPMethod = new EligibleCouple("CASE Z", "Wife 3", "Husband 3", "EC Number 3", "Village 3", "SubCenter 3", EasyMap.mapOf("currentMethod", "iud"));
        EligibleCouple outOfAreaEC = new EligibleCouple("CASE A", "Wife 4", "Husband 4", "", "Village 4", "SubCenter 4", EasyMap.mapOf("currentMethod", "condom"))
                .asOutOfArea();
        EligibleCouple closedEC = new EligibleCouple("CASE B", "Wife 5", "Husband 5", "", "Village 5", "SubCenter 5", EasyMap.mapOf("currentMethod", "iud"))
                .setIsClosed(true);
