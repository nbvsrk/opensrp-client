...
public class FormDataRepositoryTest extends AndroidTestCase {
    ...
    public void testShouldRunQueryAndGetUniqueResult() throws Exception {
        Map<String, String> details = EasyMap.create("Hello", "There").put("Also", "This").put("someKey", "someValue").map();
    ...
    public void testShouldSaveFormSubmission() throws Exception {
        Map<String, String> params = EasyMap.create("instanceId", "id 1").put("entityId", "entity id 1").put("formName", "form name").map();
        ...
        assertEquals(new FormSubmission("id 1", "entity id 1", "form name", new Gson().toJson(instance), "some version", SyncStatus.PENDING, "1"), actualFormSubmission);
        assertEquals("id 1", instanceId);
    }

    public void testShouldCheckForSyncStatusWhenSavingFormSubmission() throws Exception {
        Map<String, String> params = EasyMap.create("instanceId", "id 1").put("entityId", "entity id 1").put("formName", "form name").put( "sync_status", SyncStatus.SYNCED.value()).map();
        String paramsJSON = new Gson().toJson(params);
        ...
        FormSubmission actualFormSubmission = repository.fetchFromSubmission("id 1");
        assertNotNull(actualFormSubmission);
        assertEquals(new FormSubmission("id 1", "entity id 1", "form name", new Gson().toJson(instance), "some version", SyncStatus.SYNCED, "1"), actualFormSubmission);
        assertEquals("id 1", instanceId);
    }
    ...
    public void testShouldSaveNewEC() throws Exception {
        ...
        Map<String, String> expectedDetails = EasyMap.create("currentMethod", "ocp").put("isHighPriority", "no").map();
    ...
    public void testShouldUpdateEC() throws Exception {
        Map<String, String> fields =
                EasyMap.create("id", "entity id 1")
                        ...
                        .map();
        String fieldsJSON = new Gson().toJson(fields);
        Map<String, String> oldDetails = EasyMap.create("currentMethod", "condom")
        ...
        EligibleCouple savedEC = eligibleCoupleRepository.findByCaseID(entityId);
        Map<String, String> expectedDetails = EasyMap.create("currentMethod", "ocp")
                .put("isHighPriority", "no")
                .put("bloodGroup", "o-ve")
                .map();
    ...
    public void testShouldUpdateMotherEntity() throws Exception {
        ...
        Map<String, String> expectedDetails = EasyMap.mapOf("isHighPriority", "no");
    ...
    public void testShouldFetchPendingFormSubmissions() throws Exception {
        ...
        FormSubmission firstSubmission = new FormSubmission("id 1", "entity id 1", "form name", new Gson().toJson(instance1), "some version", SyncStatus.PENDING, "1");
        FormSubmission secondSubmission = new FormSubmission("id 2", "entity id 2", "form name", new Gson().toJson(instance2), "some other version", SyncStatus.PENDING, "1");
        FormSubmission thirdSubmission = new FormSubmission("id 3", "entity id 3", "form name", new Gson().toJson(instance3), "some other version", SyncStatus.SYNCED, "1");
    ...
    public void testShouldMarkPendingFormSubmissionsAsSynced() throws Exception {
        FormSubmission firstSubmission = new FormSubmission("id 1", "entity id 1", "form name", "", "some version", SyncStatus.PENDING, "1");
        FormSubmission secondSubmission = new FormSubmission("id 2", "entity id 2", "form name", "", "some other version", SyncStatus.PENDING, "1");
        FormSubmission thirdSubmission = new FormSubmission("id 3", "entity id 3", "form name", "", "some other version", SyncStatus.PENDING, "1");
        repository.saveFormSubmission(firstSubmission);
        repository.saveFormSubmission(secondSubmission);
        repository.saveFormSubmission(thirdSubmission);
        ...
        assertEquals(firstSubmission.setSyncStatus(SyncStatus.SYNCED), repository.fetchFromSubmission("id 1"));
        assertEquals(secondSubmission.setSyncStatus(SyncStatus.SYNCED), repository.fetchFromSubmission("id 2"));
    ...
    public void testShouldUpdateServerVersionByInstanceId() throws Exception {
        FormSubmission firstSubmission = new FormSubmission("instance 1", "entity id 1", "form name", "", "some version", SyncStatus.SYNCED, "1");
        FormSubmission secondSubmission = new FormSubmission("instance 2", "entity id 2", "form name", "", "some other version", SyncStatus.SYNCED, "1");
        FormSubmission thirdSubmission = new FormSubmission("instance 3", "entity id 3", "form name", "", "some other version", SyncStatus.PENDING, "1");
        repository.saveFormSubmission(firstSubmission);
        repository.saveFormSubmission(secondSubmission);
        repository.saveFormSubmission(thirdSubmission);
