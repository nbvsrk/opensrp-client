...
public class ClientPNCPpFpMethodView extends LinearLayout {
    ...
    public void initialize() {
        ppFpMethodView = (TextView) findViewById(org.ei.opensrp.R.id.txt_pp_fp_method_view);
        clientFpMethodView = (ClientFpMethodView) findViewById(org.ei.opensrp.R.id.fp_method_layout);
