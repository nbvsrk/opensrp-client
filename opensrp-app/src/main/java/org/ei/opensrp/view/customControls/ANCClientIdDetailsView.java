...
public class ANCClientIdDetailsView extends RelativeLayout {
    ...
    public void initialize() {
        txtThayiNumber = (TextView) findViewById(org.ei.opensrp.R.id.txt_thayi_no);
        txtMotherEcNumber = (TextView) findViewById(org.ei.opensrp.R.id.txt_mother_ec_no);
        lblThayiNumber = (TextView) findViewById(org.ei.opensrp.R.id.lbl_thayi);
        lblMotherANCNumber = (TextView) findViewById(org.ei.opensrp.R.id.lbl_mother_ec);
    }
