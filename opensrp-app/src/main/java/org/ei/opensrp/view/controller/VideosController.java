    ...
    public void play(String videoName) {
        try {
            ...
            new AlertDialog.Builder(context)
                    .setMessage(org.ei.opensrp.R.string.videos_IEC_not_installed_dialog_message)
                    .setTitle(org.ei.opensrp.R.string.videos_cannot_play_video_dialog_title)
                    .setCancelable(true)
            ...
            Log.logError(MessageFormat.format("Could not play video: {0}. Exception: {1}", videoName, e));
            new AlertDialog.Builder(context)
                    .setMessage(org.ei.opensrp.R.string.videos_unknown_error_dialog_message)
                    .setTitle(org.ei.opensrp.R.string.videos_cannot_play_video_dialog_title)
                    .setCancelable(true)
                    .setNeutralButton(android.R.string.ok,
                            new DialogInterface.OnClickListener() {
