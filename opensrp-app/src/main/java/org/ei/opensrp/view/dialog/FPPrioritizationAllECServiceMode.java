...
public class FPPrioritizationAllECServiceMode extends ServiceModeOption {
    ...
    @Override
    public String name() {
        return getInstance().getStringResource(org.ei.opensrp.R.string.fp_prioritization_all_ec_service_mode);
    }
        ...
        return new SecuredNativeSmartRegisterActivity.ClientsHeaderProvider() {
            ...
            public int[] headerTextResourceIds() {
                return new int[]{
                        ...
                        org.ei.opensrp.R.string.header_fp_prioritization_risks};
            }
        };
    }
