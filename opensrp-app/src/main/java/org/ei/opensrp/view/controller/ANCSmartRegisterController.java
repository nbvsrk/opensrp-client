...
public class ANCSmartRegisterController {
    ...
    private List<ServiceProvidedDTO> getServicesProvided(String entityId) {
        List<ServiceProvided> servicesProvided = serviceProvidedService.findByEntityIdAndServiceNames(entityId,
                ServiceProvided.IFA_SERVICE_PROVIDED_NAME,
                ServiceProvided.TT_1_SERVICE_PROVIDED_NAME,
                ServiceProvided.TT_2_SERVICE_PROVIDED_NAME,
                ServiceProvided.TT_BOOSTER_SERVICE_PROVIDED_NAME,
                ServiceProvided.HB_TEST_SERVICE_PROVIDED_NAME,
                ServiceProvided.ANC_1_SERVICE_PROVIDED_NAME,
                ServiceProvided.ANC_2_SERVICE_PROVIDED_NAME,
                ServiceProvided.ANC_3_SERVICE_PROVIDED_NAME,
                ServiceProvided.ANC_4_SERVICE_PROVIDED_NAME,
                ServiceProvided.DELIVERY_PLAN_SERVICE_PROVIDED_NAME);
