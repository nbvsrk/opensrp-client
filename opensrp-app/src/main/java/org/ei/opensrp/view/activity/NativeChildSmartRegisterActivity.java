...
public class NativeChildSmartRegisterActivity extends SecuredNativeSmartRegisterActivity {
    ...
    protected DefaultOptionsProvider getDefaultOptionsProvider() {
        return new DefaultOptionsProvider() {
            ...
            public String nameInShortFormForTitle() {
                return getResources().getString(org.ei.opensrp.R.string.child_register_title_in_short);
            }
        };
    }
    ...
    private DialogOption[] getEditOptions() {
        return new DialogOption[]{
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_child_immunizations), AllConstants.FormNames.CHILD_IMMUNIZATIONS, formController),
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_child_illness), AllConstants.FormNames.CHILD_ILLNESS, formController),
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_child_close), AllConstants.FormNames.CHILD_CLOSE, formController),
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_vitamin_a), AllConstants.FormNames.VITAMIN_A, formController)
        };
    }
