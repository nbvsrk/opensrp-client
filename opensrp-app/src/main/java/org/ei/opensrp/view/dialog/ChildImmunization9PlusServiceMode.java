...
public class ChildImmunization9PlusServiceMode extends ServiceModeOption {
    ...
    @Override
    public String name() {
        return Context.getInstance().getStringResource(org.ei.opensrp.R.string.child_service_mode_immunization_9_plus);
    }
    ...
    public SecuredNativeSmartRegisterActivity.ClientsHeaderProvider getHeaderProvider() {
        return new SecuredNativeSmartRegisterActivity.ClientsHeaderProvider() {
            ...
            public int[] headerTextResourceIds() {
                return new int[]{
                        org.ei.opensrp.R.string.header_name, org.ei.opensrp.R.string.header_id_no, org.ei.opensrp.R.string.header_measles,
                        org.ei.opensrp.R.string.header_opv_booster, org.ei.opensrp.R.string.header_dpt_booster, org.ei.opensrp.R.string.header_vitamin_a};
            }
        };
    ...
    public void setupMeaslesLayout(ChildSmartRegisterClient client,
        ...
        if (measlesAlert != AlertDTO.emptyAlert) {
    ...
    public void setupOpvBoosterLayout(ChildSmartRegisterClient client,
        ...
        if (opvBoosterAlert != AlertDTO.emptyAlert) {
    ...
    public void setupDptBoosterLayout(ChildSmartRegisterClient client,
        ...
        if (dptBoosterAlert != AlertDTO.emptyAlert) {
    ...
    public void setupVitaminALayout(ChildSmartRegisterClient client,
        ...
        if (vitaminAAlert != AlertDTO.emptyAlert) {
