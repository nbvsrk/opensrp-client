...
public class NativeANCSmartRegisterActivity extends SecuredNativeSmartRegisterActivity {
    ...
    protected DefaultOptionsProvider getDefaultOptionsProvider() {
        return new DefaultOptionsProvider() {
            ...
            public String nameInShortFormForTitle() {
                return getResources().getString(org.ei.opensrp.R.string.anc_label);
            }
        };
    }
    ...
    private DialogOption[] getEditOptions() {
        return new DialogOption[]{
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_register_anc_visit_form), AllConstants.FormNames.ANC_VISIT, formController),
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_register_hb_test_form), AllConstants.FormNames.HB_TEST, formController),
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_register_ifa_form), AllConstants.FormNames.IFA, formController),
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_register_tt_form), AllConstants.FormNames.TT, formController),
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_register_delivery_plan_form), AllConstants.FormNames.DELIVERY_PLAN, formController),
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_register_pnc_registration_form), AllConstants.FormNames.DELIVERY_OUTCOME, formController),
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_register_anc_investigations_form), AllConstants.FormNames.ANC_INVESTIGATIONS, formController),
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_register_anc_close_form), AllConstants.FormNames.ANC_CLOSE, formController)
        };
    }
    ...
    private class ClientActionHandler implements View.OnClickListener {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case org.ei.opensrp.R.id.profile_info_layout:
                    showProfileView((SmartRegisterClient) view.getTag());
                    break;
                case org.ei.opensrp.R.id.btn_edit:
