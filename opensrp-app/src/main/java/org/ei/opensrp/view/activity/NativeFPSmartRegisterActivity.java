...
public class NativeFPSmartRegisterActivity extends SecuredNativeSmartRegisterActivity {
    ...
    private static int CHECKED_TAB_ID = org.ei.opensrp.R.id.rb_fp_method;
    ...
    protected DefaultOptionsProvider getDefaultOptionsProvider() {
        return new DefaultOptionsProvider() {
            ...
            public String nameInShortFormForTitle() {
                return getResources().getString(org.ei.opensrp.R.string.fp_register_title_in_short);
            }
        };
    }
    ...
    protected NavBarOptionsProvider getNavBarOptionsProvider() {
        return new NavBarOptionsProvider() {
            ...
            public String searchHint() {
                return getString(org.ei.opensrp.R.string.str_fp_search_hint);
            }
        };
    }
    ...
    private DialogOption[] getUpdateOptions() {
        return new DialogOption[]{
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_fp_change_form), AllConstants.FormNames.FP_CHANGE, formController),
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_record_ecp_form), AllConstants.FormNames.RECORD_ECPS, formController),
        };
    }
    ...
    protected void startRegistration() {
        ...
        startFormActivity(AllConstants.FormNames.EC_REGISTRATION, null, fieldOverrides.getJSONString());
    }
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case org.ei.opensrp.R.id.profile_info_layout:
                    ...
                    break;
                case org.ei.opensrp.R.id.btn_fp_method_update:
                    NativeFPSmartRegisterActivity.super.showFragmentDialog(new UpdateDialogOptionModel(), view.getTag());
                    break;
                case org.ei.opensrp.R.id.btn_side_effects:
                    SmartRegisterClient fpClient = (SmartRegisterClient) view.getTag();
                    startFormActivity(AllConstants.FormNames.FP_COMPLICATIONS, fpClient.entityId(), null);
                    break;
                case org.ei.opensrp.R.id.lyt_fp_add:
                    NativeFPSmartRegisterActivity.super.showFragmentDialog(new UpdateDialogOptionModel(), view.getTag());
                    break;
                case org.ei.opensrp.R.id.lyt_fp_videos:
