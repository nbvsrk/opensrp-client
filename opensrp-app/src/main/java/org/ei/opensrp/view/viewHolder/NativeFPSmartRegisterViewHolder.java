...
public class NativeFPSmartRegisterViewHolder {
    ...
    public NativeFPSmartRegisterViewHolder(ViewGroup itemView) {
        ...
        this.gplsaChildLayout = (ClientGplsaChildView) itemView.findViewById(org.ei.opensrp.R.id.gplsa_child_layout);
        this.gplsaChildLayout.initialize();

        this.serviceModeFPMethodView = ((ViewGroup) itemView.findViewById(org.ei.opensrp.R.id.fp_method_service_mode_views));
        this.serviceModeFPPrioritizationView = ((ViewGroup) itemView.findViewById(org.ei.opensrp.R.id.fp_prioritization_service_mode_views));

        fpMethodview = (ClientFpMethodView) serviceModeFPMethodView.findViewById(org.ei.opensrp.R.id.fp_method_layout);
        fpMethodview.initialize();
        fpMethodview.setLayoutParams();

        btnUpdateView = (Button) serviceModeFPMethodView.findViewById(org.ei.opensrp.R.id.btn_fp_method_update);

        clientSideEffectsView = (ClientSideEffectsView) serviceModeFPMethodView.findViewById(org.ei.opensrp.R.id.side_effects_layout);

        clientSideEffectsView.initialize();

        btnSideEffectsView = (Button) serviceModeFPMethodView.findViewById(org.ei.opensrp.R.id.btn_side_effects);

        fpAlertLayout = (LinearLayout) serviceModeFPMethodView.findViewById(org.ei.opensrp.R.id.fp_alert_layout);

        txtAlertTypeView = (TextView) serviceModeFPMethodView.findViewById(org.ei.opensrp.R.id.txt_fp_alert_type);

        txtAlertDateView = (TextView) serviceModeFPMethodView.findViewById(org.ei.opensrp.R.id.txt_fp_alert_date);

        txtPrioritizationRisksView = (TextView) serviceModeFPPrioritizationView.findViewById(org.ei.opensrp.R.id.txt_fp_prioritization_risks);

        lytAddFPView = (LinearLayout) serviceModeFPPrioritizationView.findViewById(org.ei.opensrp.R.id.lyt_fp_add);

        lytFPVideosView = (LinearLayout) serviceModeFPPrioritizationView.findViewById(org.ei.opensrp.R.id.lyt_fp_videos);
    }
