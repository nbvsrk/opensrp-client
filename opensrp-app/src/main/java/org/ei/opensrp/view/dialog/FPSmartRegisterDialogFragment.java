...
public class FPSmartRegisterDialogFragment extends DialogFragment {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        ViewGroup dialogView = (ViewGroup) inflater.inflate(org.ei.opensrp.R.layout.fp_smart_register_dialog_view, container, false);
        listView = (ListView) dialogView.findViewById(org.ei.opensrp.R.id.dialog_list);
    ...
    private ArrayAdapter<DialogOption> getDialogOptionArrayAdapter(DialogOption[] options) {
        ...
        return new ArrayAdapter<DialogOption>(
                    parentActivity, org.ei.opensrp.R.layout.smart_register_dialog_list_item, options) {
                @Override
                public View getView(int position, View convertView, ViewGroup parent) {
                    ViewGroup itemView;
                    if (convertView == null) {
                        itemView = (ViewGroup) inflater.inflate(org.ei.opensrp.R.layout.smart_register_dialog_list_item, parent, false);
                    } else {
                        itemView = (ViewGroup) convertView;
                    }

                    ((TextView) itemView.findViewById(org.ei.opensrp.R.id.dialog_list_option))
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        RadioGroup rgTab = (RadioGroup) view.findViewById(org.ei.opensrp.R.id.rg_fp_tab);
        rgTab.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int checkedId) {
                ArrayAdapter<DialogOption> adapter = null;
                switch (checkedId) {
                    case org.ei.opensrp.R.id.rb_fp_method:
                        dispatchEvent(org.ei.opensrp.R.id.rb_fp_method);
                        adapter = getDialogOptionArrayAdapter(options);
                        break;
                    case org.ei.opensrp.R.id.rb_fp_prioritization:
                        dispatchEvent(org.ei.opensrp.R.id.rb_fp_prioritization);
    ...
    private int getCurrentTabSelection() {
        ...
        return org.ei.opensrp.R.id.rb_fp_method;
    }
