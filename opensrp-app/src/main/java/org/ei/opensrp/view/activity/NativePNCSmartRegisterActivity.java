...
public class NativePNCSmartRegisterActivity extends SecuredNativeSmartRegisterActivity {
    ...
    protected DefaultOptionsProvider getDefaultOptionsProvider() {
        return new DefaultOptionsProvider() {
            ...
            public String nameInShortFormForTitle() {
                return getResources().getString(org.ei.opensrp.R.string.pnc_register_title_in_short);
            }
        };
    }
    ...
    protected NavBarOptionsProvider getNavBarOptionsProvider() {
        return new NavBarOptionsProvider() {
            ...
            public String searchHint() {
                return getString(org.ei.opensrp.R.string.str_pnc_search_hint);
            }
        };
    }
    ...
    private DialogOption[] getUpdateOptions() {
        return new DialogOption[]{
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_pnc_visit_form), AllConstants.FormNames.PNC_VISIT, formController),
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_pnc_postpartum_family_planning_form), AllConstants.FormNames.PNC_POSTPARTUM_FAMILY_PLANNING, formController),
                new OpenFormOption(getString(org.ei.opensrp.R.string.str_pnc_close_form), AllConstants.FormNames.PNC_CLOSE, formController),
        };
    }
    ...
    protected void startRegistration() {
        ...
        startFormActivity(AllConstants.FormNames.PNC_REGISTRATION_OA, null, fieldOverrides.getJSONString());
    }
