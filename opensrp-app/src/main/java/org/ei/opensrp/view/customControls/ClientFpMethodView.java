...
public class ClientFpMethodView extends LinearLayout {
    ...
    public void initialize() {
        fpMethodView = (TextView) findViewById(org.ei.opensrp.R.id.txt_fp_method);
        fpMethodDateView = (TextView) findViewById(org.ei.opensrp.R.id.txt_fp_method_date);
        fpMethodQuantityLabelView = (TextView) findViewById(org.ei.opensrp.R.id.txt_fp_method_quantity_label);
        fpMethodQuantityView = (TextView) findViewById(org.ei.opensrp.R.id.txt_fp_method_quantity);
        iudPlaceView = (TextView) findViewById(org.ei.opensrp.R.id.txt_iud_place);
        iudPersonView = (TextView) findViewById(org.ei.opensrp.R.id.txt_iud_person);
    }

    public void setLayoutParams() {
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                (int) getResources().getDimension(org.ei.opensrp.R.dimen.list_fp_view_width),
                ViewGroup.LayoutParams.FILL_PARENT,
                getResources().getInteger(org.ei.opensrp.R.integer.fp_list_method_view_weight));
    ...
    public void bindData(BaseFPSmartRegisterClient client, int txtColorBlack) {
        ...
        if (fpMethod == FPMethod.NONE) {
            ...
            fpMethodQuantityLabelView.setVisibility(View.VISIBLE);
            fpMethodQuantityLabelView.setText(getInstance().getStringResource(org.ei.opensrp.R.string.str_number_given));
            fpMethodQuantityView.setVisibility(View.VISIBLE);
