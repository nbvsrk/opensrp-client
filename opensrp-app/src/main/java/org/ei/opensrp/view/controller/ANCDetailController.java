...
public class ANCDetailController {
    ...
    public String get() {
        ...
        String photoPath = isBlank(couple.photoPath()) ? AllConstants.DEFAULT_WOMAN_IMAGE_PLACEHOLDER_PATH : couple.photoPath();
    ...
    public void takePhoto() {
        ...
        intent.putExtra(AllConstants.TYPE, AllConstants.WOMAN_TYPE);
        Mother mother = allBeneficiaries.findMotherWithOpenStatus(caseId);
        intent.putExtra(AllConstants.ENTITY_ID, mother.ecCaseId());
