...
public class PNCOverviewServiceMode extends ServiceModeOption {
    ...
    @Override
    public String name() {
        return Context.getInstance().getStringResource(org.ei.opensrp.R.string.pnc_register_service_mode_overview);
    }
    ...
    public SecuredNativeSmartRegisterActivity.ClientsHeaderProvider getHeaderProvider() {
        return new SecuredNativeSmartRegisterActivity.ClientsHeaderProvider() {
            ...
            public int[] headerTextResourceIds() {
                return new int[]{
                        org.ei.opensrp.R.string.header_name, org.ei.opensrp.R.string.header_thayi_number, org.ei.opensrp.R.string.header_delivery_info,
                        org.ei.opensrp.R.string.header_delivery_complications, org.ei.opensrp.R.string.header_pp_fp, org.ei.opensrp.R.string.header_child};
            }
        };
    }
    ...
    public void setupListView(PNCSmartRegisterClient client,
        ...
        setPpFpMethodView(client, viewHolder, Context.getInstance().getColorResource(org.ei.opensrp.R.color.text_black));
    ...
    private void setPpFpMethodView(PNCSmartRegisterClient client, NativePNCSmartRegisterViewHolder viewHolder, int txtColorBlack) {
        ...
        viewHolder.txtPpFpView().setOnClickListener(launchForm(AllConstants.FormNames.PNC_POSTPARTUM_FAMILY_PLANNING, client.entityId(), null));
    ...
    private void setChildView(PNCSmartRegisterClient client, NativePNCSmartRegisterViewHolder viewHolder) {
        ...
        for (ChildClient child : client.children()) {
            ViewGroup childViewGroup = (ViewGroup) inflater.inflate(org.ei.opensrp.R.layout.smart_register_pnc_child_layout, null);
            ((TextView) childViewGroup.findViewById(org.ei.opensrp.R.id.txt_child_gender)).setText(child.gender());
            ((TextView) childViewGroup.findViewById(org.ei.opensrp.R.id.txt_child_weight)).setText(String.format(Context.getInstance().getStringResource(org.ei.opensrp.R.string.str_pnc_child_weight), child.weight()));
    ...
    private void setupEditView(PNCSmartRegisterClient client, NativePNCSmartRegisterViewHolder viewHolder, View.OnClickListener onClickListener) {
        if (iconPencilDrawable == null) {
            iconPencilDrawable = Context.getInstance().getDrawable(org.ei.opensrp.R.drawable.ic_pencil);
        }
