...
public class ClientGplsaChildView extends RelativeLayout {
    ...
    public void initialize() {
        txtGravida = (TextView) findViewById(org.ei.opensrp.R.id.txt_gravida);
        txtParity = (TextView) findViewById(org.ei.opensrp.R.id.txt_parity);
        txtNumberOfLivingChildren = (TextView) findViewById(org.ei.opensrp.R.id.txt_number_of_living_children);
        txtNumberOfStillBirths = (TextView) findViewById(org.ei.opensrp.R.id.txt_number_of_still_births);
        txtNumberOfAbortions = (TextView) findViewById(org.ei.opensrp.R.id.txt_number_of_abortions);
        txtChildAge = (TextView) findViewById(org.ei.opensrp.R.id.txt_child_age);
        txtChild = (TextView) findViewById(org.ei.opensrp.R.id.label_child);
    }
