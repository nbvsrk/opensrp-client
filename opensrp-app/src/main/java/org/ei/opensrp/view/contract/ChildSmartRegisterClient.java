...
List<String> illnessAcronyms = new ArrayList<String>(
        Arrays.asList(Context.getInstance().getStringResource(org.ei.opensrp.R.string.str_child_illness_ari),
                Context.getInstance().getStringResource(org.ei.opensrp.R.string.str_child_illness_sam)));
