...
public class PNCClient implements PNCSmartRegisterClient {
    ...
    static {
        categoriesToServiceTypeMap.put(CATEGORY_PNC, Arrays.asList(ANCServiceType.PNC));
    }
    ...
    public String deliveryDateForDisplay() {
        return DateUtil.formatFromISOString(deliveryDate, "dd/MM/YY");
    }

    @Override
    public String deliveryShortDate() {
        return DateUtil.formatFromISOString(deliveryDate, "dd/MM");
    }

    @Override
    public LocalDate deliveryDate() {
        return DateUtil.getLocalDateFromISOString(deliveryDate);
    }

    @Override
    public String deliveryPlace() {
        return StringUtil.humanizeAndDoUPPERCASE(deliveryPlace);
    }

    @Override
    public String deliveryType() {
        return StringUtil.humanize(deliveryType);
    }

    @Override
    public String deliveryComplications() {
        return StringUtil.replaceAndHumanizeWithInitCapText(deliveryComplications, AllConstants.SPACE, AllConstants.COMMA_WITH_SPACE);
    }
    ...
    public String womanDOB() {
        return DateUtil.formatDate(womanDOB, "dd/MM/YYYY");
    }
    ...
    private boolean isServiceProvided(String category) {
        ...
        return serviceProvided != null && !serviceProvided.equals(ServiceProvidedDTO.emptyService);
    }

    @Override
    public String pncComplications() {
        if (StringUtils.isNotEmpty(pncComplications))
            return StringUtil.replaceAndHumanizeWithInitCapText(pncComplications.trim(), AllConstants.SPACE, AllConstants.COMMA_WITH_SPACE);
        return null;
    }
}
