...
import org.ei.opensrp.view.contract.FPAlertType;
...
public class FPAllMethodsServiceMode extends ServiceModeOption {
    ...
    @Override
    public String name() {
        return Context.getInstance().getStringResource(org.ei.opensrp.R.string.fp_register_service_mode_all_methods);
    }
    ...
    public SecuredNativeSmartRegisterActivity.ClientsHeaderProvider getHeaderProvider() {
        return new SecuredNativeSmartRegisterActivity.ClientsHeaderProvider() {
            ...
            public int[] headerTextResourceIds() {
                return new int[]{
                        org.ei.opensrp.R.string.header_name, org.ei.opensrp.R.string.header_ec_no, org.ei.opensrp.R.string.header_gplsa,
                        org.ei.opensrp.R.string.header_method, org.ei.opensrp.R.string.header_side_effects, org.ei.opensrp.R.string.header_followup_refill};
            }
        };
    }
    ...
    public void setupListView(FPSmartRegisterClient client,
        ...
        setupFPMethodView(client, viewHolder, Context.getInstance().getColorResource(org.ei.opensrp.R.color.text_black));
    ...
    private void setupSideEffectsButtonView(FPSmartRegisterClient client, NativeFPSmartRegisterViewHolder viewHolder) {
        viewHolder.btnSideEffectsView().setOnClickListener(launchForm(AllConstants.FormNames.FP_COMPLICATIONS, client.entityId(), null));
    ...
    private void bindAlertData(FPSmartRegisterClient client, NativeFPSmartRegisterViewHolder viewHolder) {
        ...
        viewHolder.txtAlertDateView().setText(Context.getInstance().getStringResource(org.ei.opensrp.R.string.str_due) + refillFollowUps.alert().shortDate());
