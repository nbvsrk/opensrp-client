...
public class ClientProfileView extends RelativeLayout {
    ...
    public void initialize() {
        imgProfileView = (ImageView) findViewById(org.ei.opensrp.R.id.img_profile);
        txtNameView = (TextView) findViewById(org.ei.opensrp.R.id.txt_wife_name);
        txtHusbandNameView = (TextView) findViewById(org.ei.opensrp.R.id.txt_husband_name);
        txtVillageNameView = (TextView) findViewById(org.ei.opensrp.R.id.txt_village_name);
        txtAgeView = (TextView) findViewById(org.ei.opensrp.R.id.txt_age);
        txtOutOfArea = (TextView) findViewById(org.ei.opensrp.R.id.txt_out_of_area);
        badgeHPView = (ImageView) findViewById(org.ei.opensrp.R.id.img_hp_badge);
        badgeHRView = (ImageView) findViewById(org.ei.opensrp.R.id.img_hr_badge);
        badgeBPLView = (ImageView) findViewById(org.ei.opensrp.R.id.img_bpl_badge);
        badgeSCView = (ImageView) findViewById(org.ei.opensrp.R.id.img_sc_badge);
        badgeSTView = (ImageView) findViewById(org.ei.opensrp.R.id.img_st_badge);
    }
    ...
    private void setHROrHRPBadge(SmartRegisterClient client) {
        badgeHRView.setImageResource(isAnANCClient(client) ? org.ei.opensrp.R.drawable.flag_hrp : org.ei.opensrp.R.drawable.flag_hr);
    }
    ...
    private String getOutOfAreaText(String locationStatus) {
        return isOutOfArea(locationStatus) ? org.ei.opensrp.Context.getInstance().getStringResource(org.ei.opensrp.R.string.str_out_of_area) : "";
    }
