...
public class CustomFontRadioButton extends RadioButton {
    ...
    public CustomFontRadioButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(
                attrs, org.ei.opensrp.R.styleable.org_ei_drishti_view_customControls_CustomFontTextView, 0, defStyle);
        int variant = attributes.getInt(
                org.ei.opensrp.R.styleable.org_ei_drishti_view_customControls_CustomFontTextView_fontVariant, 0);
        attributes.recycle();
