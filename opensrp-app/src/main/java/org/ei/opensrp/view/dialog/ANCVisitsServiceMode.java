...
public class ANCVisitsServiceMode extends ServiceModeOption {
    ...
    @Override
    public String name() {
        return Context.getInstance().getStringResource(org.ei.opensrp.R.string.anc_service_mode_anc_visits);
    }
        ...
        return new SecuredNativeSmartRegisterActivity.ClientsHeaderProvider() {
            ...
            public int[] headerTextResourceIds() {
                return new int[]{
                        ...
                        org.ei.opensrp.R.string.header_anc_1, org.ei.opensrp.R.string.header_anc_2, org.ei.opensrp.R.string.header_anc_3, org.ei.opensrp.R.string.header_anc_4, org.ei.opensrp.R.string.header_other};
            }
        };
    }
    ...
    public void setupANCVisit1Layout(ANCSmartRegisterClient client,
        ...
        } else if (ancVisitAlert != AlertDTO.emptyAlert && ancVisitAlert.name().equalsIgnoreCase(ANC_1.shortName())) {
    ...
    public void setupANCVisit2Layout(ANCSmartRegisterClient client,
        ...
        } else if (ancVisitAlert != AlertDTO.emptyAlert && ancVisitAlert.name().equalsIgnoreCase(ANC_2.shortName())) {
    ...
    public void setupANCVisit3Layout(ANCSmartRegisterClient client,
        ...
        } else if (ancVisitAlert != AlertDTO.emptyAlert && ancVisitAlert.name().equalsIgnoreCase(ANC_3.shortName())) {
    ...
    public void setupANCVisit4Layout(ANCSmartRegisterClient client,
        ...
        } else if (ancVisitAlert != AlertDTO.emptyAlert && ancVisitAlert.name().equalsIgnoreCase(ANC_4.shortName())) {
    ...
    private void setupANCVisitView(ANCSmartRegisterClient client, NativeANCSmartRegisterViewHolder viewHolder) {
        viewHolder.btnOtherANCVisit().setOnClickListener(provider().newFormLauncher(AllConstants.FormNames.ANC_VISIT, client.entityId(), null));
    ...
    private void setAlertLayout(View layout, TextView typeView,
        ...
        layout.setOnClickListener(launchForm(AllConstants.FormNames.ANC_VISIT, client, alert));
    ...
    private void setServiceProvidedLayout(ANCSmartRegisterClient client, ServiceProvidedDTO ancServiceProvided,
        ...
        if (StringUtils.isNotEmpty(ancServiceProvided.data().get(AllConstants.ANCVisitFields.WEIGHT))) {
    ...
    private void setWeightValues(ServiceProvidedDTO ancServiceProvided, TextView lblWeight, TextView txtWeight) {
        ...
        txtWeight.setText(ancServiceProvided.data().get(AllConstants.ANCVisitFields.WEIGHT));
    }
