...
public class ChildOverviewServiceMode extends ServiceModeOption {
    private String illnessReport = Context.getInstance().getStringResource(org.ei.opensrp.R.string.illness_report);
    ...
    @Override
    public String name() {
        return Context.getInstance().getStringResource(org.ei.opensrp.R.string.child_service_mode_overview);
    }
    ...
    public SecuredNativeSmartRegisterActivity.ClientsHeaderProvider getHeaderProvider() {
        return new SecuredNativeSmartRegisterActivity.ClientsHeaderProvider() {
            ...
            public int[] headerTextResourceIds() {
                return new int[]{
                        org.ei.opensrp.R.string.header_name, org.ei.opensrp.R.string.header_id_no, org.ei.opensrp.R.string.header_dob,
                        org.ei.opensrp.R.string.header_last_service, org.ei.opensrp.R.string.header_sick_status, org.ei.opensrp.R.string.header_edit};
            }
        };
    }
    ...
    private void setupSickStatus(ChildSmartRegisterClient client,
        ...
        if (sickStatus == ChildSmartRegisterClient.ChildSickStatus.noDiseaseStatus) {
            ...
            viewHolder.sickVisitView().setOnClickListener(
                    provider().newFormLauncher(AllConstants.FormNames.CHILD_ILLNESS, client.entityId(), null));
    ...
    private void setupEditView(ChildSmartRegisterClient client,
                               NativeChildSmartRegisterViewHolder viewHolder,
                               View.OnClickListener onClickListener) {
        Drawable iconPencilDrawable = Context.getInstance().applicationContext().getResources().getDrawable(org.ei.opensrp.R.drawable.ic_pencil);
