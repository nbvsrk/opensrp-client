...
public class ChildImmunization0to9ServiceMode extends ServiceModeOption {
    ...
    @Override
    public String name() {
        return Context.getInstance().getStringResource(org.ei.opensrp.R.string.child_service_mode_immunization_0_to_9);
    }
    ...
    public SecuredNativeSmartRegisterActivity.ClientsHeaderProvider getHeaderProvider() {
        return new SecuredNativeSmartRegisterActivity.ClientsHeaderProvider() {
            ...
            public int[] headerTextResourceIds() {
                return new int[]{
                        org.ei.opensrp.R.string.header_name, org.ei.opensrp.R.string.header_id_no, org.ei.opensrp.R.string.header_bcg,
                        org.ei.opensrp.R.string.header_hep_b_birth, org.ei.opensrp.R.string.header_opv, org.ei.opensrp.R.string.header_pentavalent};
            }
        };
    ...
    public void setupHepBLayout(ChildSmartRegisterClient client,
        ...
        if (hepBAlert != AlertDTO.emptyAlert) {
    ...
    public void setupOpvLayout(ChildSmartRegisterClient client,
        ...
        if (opvAlert != AlertDTO.emptyAlert) {
    ...
    public void setupPentavLayout(ChildSmartRegisterClient client,
        ...
        if (pentavAlert != AlertDTO.emptyAlert) {
    ...
    private OnClickFormLauncher launchChildImmunizationForm(ChildSmartRegisterClient client) {
        return provider().newFormLauncher(AllConstants.FormNames.CHILD_IMMUNIZATIONS, client.entityId(), null);
    }
