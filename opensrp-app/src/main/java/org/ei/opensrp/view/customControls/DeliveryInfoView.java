...
public class DeliveryInfoView extends LinearLayout {
    ...
    public void initialize() {
        txtDeliveryDateView = (TextView) findViewById(org.ei.opensrp.R.id.txt_delivery_date);
        txtDeliveryPlaceView = (TextView) findViewById(org.ei.opensrp.R.id.txt_delivery_place);
        txtDeliveryTypeView = (TextView) findViewById(org.ei.opensrp.R.id.txt_delivery_type);
    }
