...
public class PNCVisitsServiceMode extends ServiceModeOption {
    ...
    @Override
    public String name() {
        return Context.getInstance().getStringResource(org.ei.opensrp.R.string.pnc_register_service_mode_pnc_visits);
    }
    ...
    public SecuredNativeSmartRegisterActivity.ClientsHeaderProvider getHeaderProvider() {
        return new SecuredNativeSmartRegisterActivity.ClientsHeaderProvider() {
            ...
            public int[] headerTextResourceIds() {
                return new int[]{
                        org.ei.opensrp.R.string.header_name, org.ei.opensrp.R.string.header_thayi_number, org.ei.opensrp.R.string.header_days_pp,
                        org.ei.opensrp.R.string.header_delivery_complications, org.ei.opensrp.R.string.header_first_seven_days, org.ei.opensrp.R.string.header_pnc_visits};
            }
        };
    }
    ...
    private void setUpPNCVisitLayout(PNCSmartRegisterClient client, NativePNCSmartRegisterViewHolder viewHolder) {
        ...
        if (!pncVisitAlert.equals(emptyAlert)) {
            ...
            viewHolder.layoutPNCVisitAlert().setOnClickListener(launchForm(client, pncVisitAlert, AllConstants.FormNames.PNC_VISIT));
    ...
    private void setUpPNCRecentVisits(PNCSmartRegisterClient client, NativePNCSmartRegisterViewHolder viewHolder) {
        ...
        for (ServiceProvidedDTO serviceProvided : client.recentlyProvidedServices()) {
            ViewGroup recentVisitsGroup = (ViewGroup) inflater.inflate(org.ei.opensrp.R.layout.smart_register_pnc_recent_visits_layout, null);
            ((TextView) recentVisitsGroup.findViewById(org.ei.opensrp.R.id.txt_recent_visit_day)).setText(String.valueOf(serviceProvided.day()));
            ((TextView) recentVisitsGroup.findViewById(org.ei.opensrp.R.id.txt_recent_visit_date)).setText(serviceProvided.dateForDisplay());
