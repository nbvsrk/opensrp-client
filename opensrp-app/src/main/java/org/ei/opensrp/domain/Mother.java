...
public class Mother {
    ...
    public boolean isHighRisk() {
        return AllConstants.BOOLEAN_TRUE.equals(details.get(AllConstants.ANCRegistrationFields.IS_HIGH_RISK));
    }

    public String highRiskReason() {
        String highRiskReason = details.get(AllConstants.ANCRegistrationFields.HIGH_RISK_REASON) == null ? "" : details.get(AllConstants.ANCRegistrationFields.HIGH_RISK_REASON).trim();
