...
public class Child {
    ...
    public boolean isHighRisk() {
        return AllConstants.BOOLEAN_TRUE.equals(details.get(AllConstants.ChildRegistrationFields.IS_CHILD_HIGH_RISK));
    }
    ...
    public String highRiskReason() {
        String highRiskReason = details.get(AllConstants.ChildRegistrationFields.HIGH_RISK_REASON) == null ? "" : details.get(AllConstants.ChildRegistrationFields.HIGH_RISK_REASON);
        return StringUtils.join(new HashSet<String>(Arrays.asList(highRiskReason.split(AllConstants.SPACE))).toArray(), AllConstants.SPACE);
    }
