...
public class ServiceProvided {
    ...
    public static ServiceProvided forTTDose(String entityId, String ttDose, String date) {
        ...
        return new ServiceProvided(entityId, mappedTTDose, date, EasyMap.mapOf("dose", mappedTTDose));
    }

    public static ServiceProvided forHBTest(String entityId, String hbLevel, String date) {
        return new ServiceProvided(entityId, HB_TEST_SERVICE_PROVIDED_NAME, date, EasyMap.mapOf("hbLevel", hbLevel));
    }

    public static ServiceProvided forIFATabletsGiven(String entityId, String numberOfIFATabletsGiven, String date) {
        return new ServiceProvided(entityId, IFA_SERVICE_PROVIDED_NAME, date, EasyMap.mapOf("dose", numberOfIFATabletsGiven));
    }
    ...
    public static ServiceProvided forANCCareProvided(String entityId, String ancVisitNumber, String date, String bpSystolic, String bpDiastolic, String weight) {
        return new ServiceProvided(entityId, ANC_SERVICE_PREFIX + ancVisitNumber, date,
                EasyMap.create(AllConstants.ANCVisitFields.BP_SYSTOLIC, bpSystolic)
                        .put(AllConstants.ANCVisitFields.BP_DIASTOLIC, bpDiastolic)
                        .put(AllConstants.ANCVisitFields.WEIGHT, weight)
                        .map()
        );
    }
    ...
    public static ServiceProvided forMotherPNCVisit(String entityId, String pncVisitDay, String date) {
        return new ServiceProvided(entityId, PNC_SERVICE_PROVIDED_NAME, date,
                EasyMap.mapOf(PNC_VISIT_DAY, pncVisitDay)
        );
    }
    ...
    public static ServiceProvided forDeliveryPlan(String entityId, String deliveryFacilityName, String transportationPlan, String birthCompanion, String ashaPhoneNumber, String familyContactNumber, String highRiskReason, String date) {
        return new ServiceProvided(entityId, DELIVERY_PLAN_SERVICE_PROVIDED_NAME, date,
                EasyMap.create(AllConstants.DeliveryPlanFields.DELIVERY_FACILITY_NAME, deliveryFacilityName)
                        .put(AllConstants.DeliveryPlanFields.TRANSPORTATION_PLAN, transportationPlan)
                        .put(AllConstants.DeliveryPlanFields.BIRTH_COMPANION, birthCompanion)
                        .put(AllConstants.DeliveryPlanFields.ASHA_PHONE_NUMBER, ashaPhoneNumber)
                        .put(AllConstants.DeliveryPlanFields.PHONE_NUMBER, familyContactNumber)
                        .put(AllConstants.DeliveryPlanFields.REVIEWED_HRP_STATUS, highRiskReason).map()
        );
    }
    ...
    public static ServiceProvided forVitaminAProvided(String entityId, String date, String vitaminADose, String vitaminAPlace) {
        return new ServiceProvided(entityId, VITAMIN_A_SERVICE_PROVIDED_NAME, date,
                EasyMap.create(AllConstants.VitaminAFields.VITAMIN_A_DOSE, vitaminADose).put(AllConstants.VitaminAFields.VITAMIN_A_PLACE, vitaminAPlace).map());
    }
