...
public class EligibleCouple {
    ...
    public boolean isHighPriority() {
        return parseDetailFieldValueToBoolean(AllConstants.ECRegistrationFields.IS_HIGH_PRIORITY);
    }

    public String highPriorityReason() {
        String highRiskReason = details.get(AllConstants.ECRegistrationFields.HIGH_PRIORITY_REASON) == null ? "" : details.get(AllConstants.ECRegistrationFields.HIGH_PRIORITY_REASON);
