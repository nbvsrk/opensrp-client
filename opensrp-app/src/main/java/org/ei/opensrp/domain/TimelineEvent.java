...
public class TimelineEvent {
    ...
    public static TimelineEvent forChildBirthInChildProfile(String caseId, String dateOfBirth, String weight, String immunizationsGiven) {
        Map<String, String> details = EasyMap.create("childWeight", weight).put("immunizationsGiven", immunizationsGiven).map();
    ...
    public static TimelineEvent forChildBirthInMotherProfile(String caseId, String dateOfBirth, String gender, String dateOfDelivery, String placeOfDelivery) {
        Map<String, String> details = EasyMap.create("dateOfDelivery", dateOfDelivery).put("placeOfDelivery", placeOfDelivery).map();
    ...
    public static TimelineEvent forChildBirthInECProfile(String caseId, String dateOfBirth, String gender, String dateOfDelivery) {
        String detailsString = new DetailBuilder(EasyMap.mapOf("dateOfDelivery", dateOfDelivery)).withDateOfDelivery("dateOfDelivery").value();
        String title = gender.equals("male") ? "Boy" : "Girl" + " Delivered";
        return new TimelineEvent(caseId, "CHILD-BIRTH", LocalDate.parse(dateOfBirth), title, detailsString, null);
    }
    ...
    public static TimelineEvent forDeliveryPlan(String caseId, String deliveryFacilityName, String transportationPlan, String birthCompanion, String ashaPhoneNumber, String familyContactNumber, String highRiskReason, String referenceDate) {
        Map<String, String> map = EasyMap.create("deliveryFacilityName", deliveryFacilityName)
    ...
    public static TimelineEvent forMotherPNCVisit(String caseId, String visitNumber, String visitDate, String bpSystolic, String bpDiastolic, String temperature, String hbLevel) {
        Map<String, String> details = EasyMap.create(AllConstants.PNCVisitFields.BP_SYSTOLIC, bpSystolic).put(AllConstants.PNCVisitFields.BP_DIASTOLIC, bpDiastolic).put(AllConstants.PNCVisitFields.TEMPERATURE, temperature).put(AllConstants.PNCVisitFields.HB_LEVEL, hbLevel).map();
        String detailsString = new DetailBuilder(details).withBP(AllConstants.PNCVisitFields.BP_SYSTOLIC, AllConstants.PNCVisitFields.BP_DIASTOLIC).withTemperature(AllConstants.PNCVisitFields.TEMPERATURE).withHbLevel(AllConstants.PNCVisitFields.HB_LEVEL).value();
    ...
    public static TimelineEvent forChildPNCVisit(String caseId, String visitNumber, String visitDate, String weight, String temperature) {
        Map<String, String> details = EasyMap.create("childWeight", weight).put("childTemperature", temperature).map();
