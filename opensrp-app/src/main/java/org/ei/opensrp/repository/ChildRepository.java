...
public class ChildRepository extends DrishtiRepository {
    ...
    public List<Child> allChildrenWithMotherAndEC() {
        ...
        Cursor cursor = database.rawQuery("SELECT " +
                ...
                tableColumnsForQuery(MotherRepository.MOTHER_TABLE_NAME, MotherRepository.MOTHER_TABLE_COLUMNS) + ", " +
                tableColumnsForQuery(EC_TABLE_NAME, EC_TABLE_COLUMNS) +
                " FROM " + CHILD_TABLE_NAME + ", " + MotherRepository.MOTHER_TABLE_NAME + ", " + EC_TABLE_NAME +
                " WHERE " + CHILD_TABLE_NAME + "." + IS_CLOSED_COLUMN + "= '" + NOT_CLOSED + "' AND " +
                CHILD_TABLE_NAME + "." + MOTHER_ID_COLUMN + " = " + MotherRepository.MOTHER_TABLE_NAME + "." + MotherRepository.ID_COLUMN
                + " AND " + MotherRepository.MOTHER_TABLE_NAME + "." + MotherRepository.EC_CASEID_COLUMN + " = " + EC_TABLE_NAME + "." + EligibleCoupleRepository.ID_COLUMN,
                null);
    ...
    private Mother motherFromCursor(Cursor cursor) {
        return new Mother(
                getColumnValueByAlias(cursor, MotherRepository.MOTHER_TABLE_NAME, MotherRepository.ID_COLUMN),
                getColumnValueByAlias(cursor, MotherRepository.MOTHER_TABLE_NAME, MotherRepository.EC_CASEID_COLUMN),
                getColumnValueByAlias(cursor, MotherRepository.MOTHER_TABLE_NAME, MotherRepository.THAYI_CARD_NUMBER_COLUMN),
                getColumnValueByAlias(cursor, MotherRepository.MOTHER_TABLE_NAME, MotherRepository.REF_DATE_COLUMN))
                .withDetails(new Gson().<Map<String, String>>fromJson(getColumnValueByAlias(cursor, MotherRepository.MOTHER_TABLE_NAME, MotherRepository.DETAILS_COLUMN), new TypeToken<Map<String, String>>() {
                }.getType()));
    }
    ...
    public List<Child> findAllChildrenByECId(String ecId) {
        ...
        Cursor cursor = database.rawQuery("SELECT " +
                ...
                " WHERE " + CHILD_TABLE_NAME + "." + IS_CLOSED_COLUMN + "= '" + NOT_CLOSED + "' AND " +
                CHILD_TABLE_NAME + "." + MOTHER_ID_COLUMN + " = " + MotherRepository.MOTHER_TABLE_NAME + "." + MotherRepository.ID_COLUMN
                + " AND " + MotherRepository.MOTHER_TABLE_NAME + "." + MotherRepository.EC_CASEID_COLUMN + " = " + EC_TABLE_NAME + "." +
