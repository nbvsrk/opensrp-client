...
public class HTTPAgent {
    ...
    public LoginResponse urlCanBeAccessWithGivenCredentials(String requestURL, String userName, String password) {
        ...
        try {
            ...
            if (statusCode == HttpStatus.SC_OK) {
                return SUCCESS.withPayload(HttpResponseUtil.getResponseBody(response));
    ...
    private SocketFactory sslSocketFactoryWithDrishtiCertificate() {
        try {
            ...
            InputStream inputStream = context.getResources().openRawResource(org.ei.opensrp.R.raw.dristhi_client);
            try {
