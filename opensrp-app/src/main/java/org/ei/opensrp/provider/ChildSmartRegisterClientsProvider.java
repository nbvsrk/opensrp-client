...
public class ChildSmartRegisterClientsProvider implements SmartRegisterClientsProvider {
    ...
    public ChildSmartRegisterClientsProvider(SecuredActivity activity,
        ...
        photoLoader = new ChildRegisterProfilePhotoLoader(
                activity.getResources().getDrawable(org.ei.opensrp.R.drawable.child_boy_infant),
                activity.getResources().getDrawable(org.ei.opensrp.R.drawable.child_girl_infant));
    ...
    public View getView(SmartRegisterClient smartRegisterClient, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            itemView = (ViewGroup) inflater().inflate(org.ei.opensrp.R.layout.smart_register_child_client, null);
