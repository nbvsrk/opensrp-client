...
import org.ei.opensrp.view.dialog.FPMethodFilter;
import org.ei.opensrp.view.dialog.FPPrioritizationMethodFilter;
...
public class FPSmartRegisterClientsProvider implements SmartRegisterClientsProvider {
    ...
    public FPSmartRegisterClientsProvider(SecuredActivity activity,
        ...
        photoLoader = new ECProfilePhotoLoader(activity.getResources(),
                activity.getResources().getDrawable(org.ei.opensrp.R.drawable.woman_placeholder));

        clientViewLayoutParams = new AbsListView.LayoutParams(MATCH_PARENT,
                (int) activity.getResources().getDimension(org.ei.opensrp.R.dimen.list_item_height));
    }
    ...
    public View getView(SmartRegisterClient smartRegisterClient, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            itemView = (ViewGroup) inflater().inflate(org.ei.opensrp.R.layout.smart_register_fp_client, null);
