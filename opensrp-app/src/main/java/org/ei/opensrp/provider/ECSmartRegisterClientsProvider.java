...
public class ECSmartRegisterClientsProvider implements SmartRegisterClientsProvider {
    ...
    public ECSmartRegisterClientsProvider(Context context,
        ...
        photoLoader = new ECProfilePhotoLoader(context.getResources(),
                context.getResources().getDrawable(org.ei.opensrp.R.drawable.woman_placeholder));

        maleChildAgeFormatString = context.getResources().getString(org.ei.opensrp.R.string.ec_register_male_child);
        femaleChildAgeFormatString = context.getResources().getString(org.ei.opensrp.R.string.ec_register_female_child);
    ...
    public View getView(SmartRegisterClient smartRegisterClient, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            itemView = (ViewGroup) inflater().inflate(org.ei.opensrp.R.layout.smart_register_ec_client, null);
    ...
    private void setupEditView(ECSmartRegisterClient client, NativeECSmartRegisterViewHolder viewHolder) {
        if (iconPencilDrawable == null) {
            iconPencilDrawable = context.getResources().getDrawable(org.ei.opensrp.R.drawable.ic_pencil);
        }
