...
public class AllSharedPreferencesTest extends TestCase {
    ...
    public void shouldFetchLanguagePreference() throws Exception {
        when(preferences.getString(AllConstants.LANGUAGE_PREFERENCE_KEY, AllConstants.DEFAULT_LOCALE)).thenReturn(AllConstants.ENGLISH_LANGUAGE);
    ...
    public void shouldFetchIsSyncInProgress() throws Exception {
        when(preferences.getBoolean(AllConstants.IS_SYNC_IN_PROGRESS_PREFERENCE_KEY, false)).thenReturn(true);
    ...
    public void shouldSaveIsSyncInProgress() throws Exception {
        ...
        when(editor.putBoolean(AllConstants.IS_SYNC_IN_PROGRESS_PREFERENCE_KEY, true)).thenReturn(editor);

        allSharedPreferences.saveIsSyncInProgress(true);

        verify(editor).putBoolean(AllConstants.IS_SYNC_IN_PROGRESS_PREFERENCE_KEY, true);
