...
public class TimelineEventTest {
    ...
    public void shouldCreateTimelineEventForChildBirthInMotherProfileWithDetails() throws Exception {
        TimelineEvent timelineEvent = TimelineEvent.forChildBirthInMotherProfile("CASE A", "2012-08-01", "male", "2012-08-01", "Govt Hospital");
    ...
    public void shouldCreateTimelineEventWithTitleBasedOnSex() throws Exception {
        ...
        timelineEvent = TimelineEvent.forChildBirthInMotherProfile("CASE A", "2012-08-01", "female", "2012-08-01", "Govt Hospital");
    ...
    public void shouldCreateTimelineEventForChildBirthInMotherProfileExcludingThoseDetailsWhichDoNotHaveValue() throws Exception {
        TimelineEvent timelineEvent = TimelineEvent.forChildBirthInMotherProfile("CASE A", "2012-01-01", "male", null, null);
    ...
    public void shouldCreateTimelineEventForChildBirthInECProfileWithDetails() throws Exception {
        TimelineEvent timelineEvent = TimelineEvent.forChildBirthInECProfile("CASE A", "2012-08-01", "male", "2012-08-01");
    ...
    public void shouldCreateTimelineEventForChildBirthInChildProfileWithDetails() throws Exception {
        TimelineEvent timelineEvent = TimelineEvent.forChildBirthInChildProfile("CASE A", "2012-08-01", "4", "bcg opv_0 hepb_0");
    ...
    public void shouldCreateTimelineEventForChildBirthInChildProfileExcludingThoseDetailsWhichDoNotHaveValue() throws Exception {
        TimelineEvent timelineEvent = TimelineEvent.forChildBirthInChildProfile("CASE A", "2012-01-01", null, null);
    ...
    public void shouldCreateTimelineEventForFPCondomRenew() throws Exception {
        Map<String, String> details = EasyMap.create("Key 1", "Value 1")
    ...
    public void shouldCreateTimelineEventForDeliveryPlan() throws Exception {
        ...
        TimelineEvent timelineEvent = TimelineEvent.forDeliveryPlan("Case 1", "Delivery Facility Name", "Transportation Plan", "Birth Companion", "1234567890", "Contact Number", "High Risk Reason", "2012-03-03");
