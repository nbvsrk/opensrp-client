...
public class PNCClientPreProcessorTest {
    ...
    public void setUp() throws Exception {
        ...
        when(mockedContext.getStringResource(org.ei.opensrp.R.string.str_pnc_circle_type_expected)).thenReturn("expected");
        when(mockedContext.getStringResource(org.ei.opensrp.R.string.str_pnc_circle_type_actual)).thenReturn("actual");
    }
