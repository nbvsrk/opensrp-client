...
public class EligibleCoupleDetailControllerTest {
    ...
    public void shouldGetANCDetailsAsJSON() {
        org.ei.opensrp.domain.TimelineEvent pregnancyEvent = org.ei.opensrp.domain.TimelineEvent.forStartOfPregnancyForEC(caseId, "TC 1", "2011-10-21", "2011-10-21");
        org.ei.opensrp.domain.TimelineEvent fpEvent = org.ei.opensrp.domain.TimelineEvent.forChangeOfFPMethod(caseId, "condom", "iud", "2011-12-22");
        org.ei.opensrp.domain.TimelineEvent eventVeryCloseToCurrentDate = org.ei.opensrp.domain.TimelineEvent.forChangeOfFPMethod(caseId, "iud", "condom", "2012-07-29");
