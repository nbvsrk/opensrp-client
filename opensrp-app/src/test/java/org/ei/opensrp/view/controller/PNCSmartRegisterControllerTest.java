...
public class PNCSmartRegisterControllerTest {
    ...
    public void shouldMapPNCToPNCClient() throws Exception {
        ...
        when(allBeneficiaries.findAllChildrenByMotherId("Entity X")).thenReturn(asList(new Child("child id 1", "Entity X", "male", EasyMap.mapOf("weight", "2.4")),
    ...
    public void shouldCreatePNCClientsWithServicesProvided() throws Exception {
        ...
        when(serviceProvidedService.findByEntityIdAndServiceNames("Entity X", PNC_SERVICES))
                .thenReturn(asList(new ServiceProvided("entity id 1", "PNC 1", "2013-01-01", EasyMap.mapOf("dose", "100")), new ServiceProvided("entity id 1", "PNC 1", "2013-02-01", emptyMap)));
        List<ServiceProvidedDTO> expectedServicesProvided = asList(new ServiceProvidedDTO("PNC 1", "2013-01-01", EasyMap.mapOf("dose", "100")),
