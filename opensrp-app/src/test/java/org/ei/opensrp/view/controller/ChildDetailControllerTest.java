...
public class ChildDetailControllerTest {
    ...
    public void shouldGetChildDetailsAsJSON() throws Exception {
        org.ei.opensrp.domain.TimelineEvent birthEvent = org.ei.opensrp.domain.TimelineEvent.forChildBirthInChildProfile(caseId, "2011-10-21", null, null);
        org.ei.opensrp.domain.TimelineEvent ancEvent = org.ei.opensrp.domain.TimelineEvent.forMotherPNCVisit(caseId, "2", "2011-12-22", "bps 1", "bpd 1", "temp 1", "hb 1");
        org.ei.opensrp.domain.TimelineEvent eventVeryCloseToCurrentDate = org.ei.opensrp.domain.TimelineEvent.forMotherPNCVisit(caseId, "2", "2012-07-29", "bps 2", "bpd 2", "temp 2", "hb 2");
    ...
    private TimelineEvent eventFor(org.ei.opensrp.domain.TimelineEvent pregnancyEvent, String expectedRelativeTime) {
        return new TimelineEvent(pregnancyEvent.type(), pregnancyEvent.title(), new String[]{pregnancyEvent.detail1(), pregnancyEvent.detail2()}, expectedRelativeTime);
    }
}
