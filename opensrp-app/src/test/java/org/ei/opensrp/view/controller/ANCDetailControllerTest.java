...
public class ANCDetailControllerTest {
    ...
    public void shouldGetANCDetailsAsJSON() {
        org.ei.opensrp.domain.TimelineEvent pregnancyEvent = org.ei.opensrp.domain.TimelineEvent.forStartOfPregnancy(caseId, "2011-10-21", "2011-10-21");
        org.ei.opensrp.domain.TimelineEvent ancEvent = org.ei.opensrp.domain.TimelineEvent.forANCCareProvided(caseId, "2", "2011-12-22", new HashMap<String, String>());
        org.ei.opensrp.domain.TimelineEvent eventVeryCloseToCurrentDate = org.ei.opensrp.domain.TimelineEvent.forANCCareProvided(caseId, "2", "2012-07-29", new HashMap<String, String>());
    ...
    private org.ei.opensrp.view.contract.TimelineEvent eventFor(org.ei.opensrp.domain.TimelineEvent pregnancyEvent, String expectedRelativeTime) {
