...
import org.ei.opensrp.view.dialog.VillageFilter;
...
public class SmartRegisterClientsTest {
    ...
    public void ShouldReturnFilteredListForFP() {
        when(applicationContext.getString(org.ei.opensrp.R.string.fp_register_service_mode_condom)).thenReturn("Condom");
