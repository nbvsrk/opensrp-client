...
public class MotherServiceTest {
    ...
    public void shouldCreateTimelineEventsWhenANCVisitHappens() throws Exception {
        ...
        verify(allTimelineEvents).add(TimelineEvent.forANCCareProvided("entity id 1", "2", "2013-01-01",
                EasyMap.create("bpDiastolic", "80").put("bpSystolic", "90").put("temperature", "98.5").put("weight", "21").map()));
    }
    ...
    public void shouldAddServiceProvidedWhenANCVisitHappens() throws Exception {
        ...
        verify(serviceProvidedService).add(
                new ServiceProvided("entity id 1", "ANC 1", "2013-01-01", EasyMap.create("bpDiastolic", "80").put("bpSystolic", "90").put("weight", "21").map()));
    }
    ...
    public void shouldHandleTTProvided() throws Exception {
        ...
        verify(allTimelineEvents).add(TimelineEvent.forTTShotProvided("entity id 1", "ttbooster", "2013-01-01"));
        verify(serviceProvidedService).add(new ServiceProvided("entity id 1", "TT Booster", "2013-01-01", EasyMap.mapOf("dose", "TT Booster")));
    }
    ...
    public void shouldAddTimelineEventWhenIFATabletsAreGiven() throws Exception {
        ...
        verify(allTimelineEvents).add(TimelineEvent.forIFATabletsGiven("entity id 1", "100", "2013-02-01"));
    }
    ...
    public void shouldAddServiceProvidedWhenIFATabletsAreGiven() throws Exception {
        ...
        service.ifaTabletsGiven(submission);
        verify(serviceProvidedService).add(new ServiceProvided("entity id 1", "IFA", "2013-02-01", EasyMap.mapOf("dose", "100")));
    }
    ...
    public void shouldHandleHBTest() throws Exception {
        ...
        verify(serviceProvidedService).add(new ServiceProvided("entity id 1", "Hb Test", "2013-01-01", EasyMap.mapOf("hbLevel", "11")));
    }
    ...
    public void shouldAddIFATabletsGivenTimelineEventWhenPNCVisitHappens() throws Exception {
        ...
        verify(allTimelineEvents).add(TimelineEvent.forIFATabletsGiven("entity id 1", "100", "2012-01-02"));
    }
    ...
    public void shouldAddPNCVisitServiceProvidedWhenPNCVisitHappens() throws Exception {
        ...
        verify(serviceProvidedService).add(new ServiceProvided("entity id 1", "PNC", "2012-01-01", EasyMap.mapOf("day", "2")));
    }
    ...
    public void shouldNotAddIFATabletsGivenTimelineEventWhenPNCVisitHappensAndNoIFATabletsWereGiven() throws Exception {
        ...
        verify(allTimelineEvents, times(0)).add(TimelineEvent.forIFATabletsGiven("entity id 1", "2012-01-01", "100"));
    }
    ...
    public void shouldAddTimelineEventWhenDeliveryPlanHappens() throws Exception {
        ...
        verify(allTimelineEvents).add(TimelineEvent.forDeliveryPlan("entity id 1", "Delivery Facility Name", "Transportation Plan", "Birth Companion", "Asha Phone", "1234567890", "HRP Status", "2012-01-01"));
    }
