...
public class ChildServiceTest {
    ...
    public void shouldUpdateEveryOnlyNewlyBornChildrenWhileRegistering() throws Exception {
        ...
        when(subForm.instances()).thenReturn(asList(EasyMap.mapOf("id", "Child X"), EasyMap.mapOf("id", "Child Y")));
    ...
    public void shouldDeleteRegisteredChildWhenDeliveryOutcomeIsStillBirth() throws Exception {
        ...
        when(submission.getSubFormByName("child_registration")).thenReturn(subForm);
        when(subForm.instances()).thenReturn(asList(EasyMap.mapOf("id", "Child X")));
    ...
    public void shouldAddTimelineEventWhenChildIsRegisteredForEC() throws Exception {
        ...
        verify(serviceProvidedService).add(ServiceProvided.forChildImmunization("child id 1", "bcg", "2012-01-06"));
        verify(serviceProvidedService).add(ServiceProvided.forChildImmunization("child id 1", "opv_0", "2012-01-07"));
    }
    ...
    public void shouldHandleStillBirthWhenPNCVisitHappens() throws Exception {
        ...
        when(submission.getFieldValue("deliveryOutcome")).thenReturn("still_birth");
        when(submission.getSubFormByName("child_pnc_visit")).thenReturn(subForm);
        when(subForm.instances()).thenReturn(asList(EasyMap.create("id", "child id 1").map()));
    ...
    public void shouldAddPNCVisitServiceProvidedWhenPNCVisitHappens() throws Exception {
        ...
        when(submission.getSubFormByName("child_pnc_visit")).thenReturn(subForm);
        when(subForm.instances()).thenReturn(
                asList(EasyMap.mapOf("id", "child id 1"), EasyMap.mapOf("id", "child id 2")));

        service.pncVisitHappened(submission);

        verify(serviceProvidedService).add(new ServiceProvided("child id 1", "PNC", "2012-01-01", EasyMap.mapOf("day", "2")));
        verify(serviceProvidedService).add(new ServiceProvided("child id 2", "PNC", "2012-01-01", EasyMap.mapOf("day", "2")));
    }
    ...
    public void shouldUpdateIllnessForUpdateIllnessAction() throws Exception {
        ...
        verify(serviceProvidedService).add(ServiceProvided.forChildIllnessVisit("child id 1", "2012-01-01", map));
    }
    ...
    public void shouldUpdateVitaminADosagesForUpdateVitaminAProvidedAction() throws Exception {
        ...
        verify(serviceProvidedService).add(ServiceProvided.forVitaminAProvided("child id 1", "2012-01-01", "1", "PHC"));
    }
    ...
    public void shouldAddTimelineEventWhenChildIsRegisteredForOA() throws Exception {
        ...
        verify(serviceProvidedService).add(ServiceProvided.forChildImmunization("ec id 1", "bcg", "2012-01-06"));
        verify(serviceProvidedService).add(ServiceProvided.forChildImmunization("ec id 1", "opv_0", "2012-01-07"));
    }
}
